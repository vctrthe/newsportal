...
func (co *contentService) GetContents(ctx context.Context, query entity.QueryString) ([]entity.ContentEntity, int64, int64, error) {
	results, totalData, totalPages, err := co.contentRepository.GetContents(ctx, query)
	if err != nil {
